...
## Project Structure
    ...
    ├── testdragdrop_dev_26117  # Django project configurations
...
1. Clone this repo and `cd testdragdrop_dev_26117`
...
2. Clone this repo and `cd testdragdrop_dev_26117`
